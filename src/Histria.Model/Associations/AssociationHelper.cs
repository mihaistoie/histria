...
namespace Histria.Model
{
    public class AssociationHelper
    {
        ...
        ///</summary> 
        internal static void UpdateForeignKeys(PropInfoItem Propinfo, IInterceptedObject target, IInterceptedObject refObj)
        {
        ...
        /// <summary>
        /// Remove Instance from his Parent
        /// </summary>
        ...
        /// <summary>
        /// Remove all childrens of instance
        /// </summary>
        /// <param name="instance"></param>
        ...
        ///<summary>
        /// Enumerate all children of instance
        ///</summary> 
        public static void EnumChildren(IInterceptedObject instance, bool deeperChildrenBefore, Action<IInterceptedObject> callBack)
        {
            ClassInfoItem ci = instance.ClassInfo;
            for (int index = 0, len = ci.Roles.Count; index < len; index++)
            {
                ...
                if (pi.Role.IsParent)
                {
                    ...
                    foreach (IInterceptedObject ii in collection)
                    {
                        if (deeperChildrenBefore)
                        {
                            EnumChildren(ii, deeperChildrenBefore, callBack);
                            callBack(ii);
                        }
                        else
                        {
